<script>
	...
	import ContactMeIcon from './components/contact-me-icon.svelte'
...
<SelfDetails
	...
	description = "mainly a <strong>React-Native Engineer Contributor</strong> at Crocodic Studio in Semarang, Indonesia.<br />also can contribute on other digital fields. And love teaching to empowering others."
/>
